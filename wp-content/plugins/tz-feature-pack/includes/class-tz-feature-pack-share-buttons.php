...
class tz_share_buttons {
    ...
    if ( class_exists('Woocommerce') && is_product() ) {
      return '<div class="tz-social-links"><span class="heading">'.esc_html__('Share ', 'tz-feature-pack').'('.esc_attr($shares_total).')</span><div class="wrapper">'.implode('', $button_array).'</div></div>';
    } else {
      return '<div class="tz-social-links"><span class="heading"><i class="share-icon"></i>'.esc_html__('Share ', 'tz-feature-pack').'('.esc_attr($shares_total).')</span><div class="wrapper">'.implode('', $button_array).'</div></div>';
    }
	}
