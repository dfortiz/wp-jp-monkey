	...
	public function widget( $args, $instance ) {
		...
		<?php if ( ! empty( $precontent ) ) {
			...
			<ul itemprop="sourceOrganization" itemscope="itemscope" itemtype="http://schema.org/LocalBusiness">
				...
				<?php if($address != '' ) : ?><li class="option-title a-address"><span class="address" itemprop="address"><span class="label"><?php esc_html_e('Address: ', 'tz-feature-pack'); ?></span><?php echo strip_tags($address, '<br><span>'); ?></span></li><?php endif; ?>
				<?php if($phone != '' ) : ?><li class="option-title a-phone"><span class="phone" itemprop="telephone"><span class="label"><?php esc_html_e('Phone: ', 'tz-feature-pack'); ?></span><?php echo strip_tags($phone, '<br><span>'); ?></span></li><?php endif; ?>
				<?php if($fax != '' ) : ?><li class="option-title a-fx"><span class="fax"><span class="label"><?php esc_html_e('Fax: ', 'tz-feature-pack'); ?></span><?php echo esc_attr($fax); ?></span></li><?php endif; ?>
				<?php if($skype != '' ) : ?><li class="option-title a-skype"><span class="skype"><span class="label"><?php esc_html_e('Skype: ', 'tz-feature-pack'); ?></span><?php echo esc_attr($skype); ?></span></li><?php endif; ?>
				<?php if($email != '' ) : ?><li class="option-title a-email"><span class="email" itemprop="email"><span class="label"><?php esc_html_e('E-mail: ', 'tz-feature-pack'); ?></span><a title="Email us" href="mailto:<?php echo esc_attr($email); ?>"><?php echo esc_attr($email); ?></a></span></li><?php endif; ?>
				<?php if($working_hours != '' ) : ?><li class="option-title a-hours"><span class="hours"><span class="label"><?php esc_html_e('Working Hours: ', 'tz-feature-pack'); ?></span><?php echo strip_tags($working_hours, '<br><span>'); ?></span></li><?php endif; ?>
			</ul>
