...
class Tz_Feature_Pack {
	...
	public function elementor_widgets_init() {
		...
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/elementor/class-tz-feature-pack-elementor-woo-codes.php';
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new TZ_Woo_Codes() );
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/elementor/class-tz-feature-pack-elementor-product-tabs.php';
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new TZ_Product_Tabs() );
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/elementor/class-tz-feature-pack-elementor-hoverable-tabs.php';
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new TZ_Hoverable_Tabs() );
		...
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/elementor/class-tz-feature-pack-elementor-categories.php';
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new TZ_Categories_Grid() );
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/elementor/class-tz-feature-pack-elementor-sale-carousel.php';
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new TZ_Sale_Carousel() );
